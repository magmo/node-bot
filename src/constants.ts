import { Uint256, Address } from "fmg-core";
...
export const PARTICIPANT_PRIVATE_KEY = '0xa205281c09d630f6639c3505b63d57013996ba037bdbe4d2979eb8bd5bed5b1b';
export const PARTICIPANT_ADDRESS = '0xffff6147243897776F085aBF5F45F24FC2943669';

export const OTHER_PRIVATE_KEY = '0xc19d583e30a7ab6ab346505c216491ac74dd988cf833a7c29cbf2e57ab41e20c'
...
export const FUNDED_CHANNEL_HOLDINGS = 3;

export const BEGINNING_APP_CHANNEL_NONCE = 4;
export const BEGINNING_APP_CHANNEL_HOLDINGS = 10;

export const ONGOING_APP_CHANNEL_NONCE = 5;
export const ONGOING_APP_CHANNEL_HOLDINGS = 12;

export const SEEDED_CHANNELS = 5;
export const SEEDED_COMMITMENTS = 6;
export const SEEDED_ALLOCATIONS = SEEDED_COMMITMENTS * 2;
export const SEEDED_PARTICIPANTS = SEEDED_CHANNELS * 2;


export const NONCE = 1000; // just a big number that won't be hit in seeding
